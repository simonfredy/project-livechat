	...
	<div class="container">
		<div class="row">
			<div class="span4 offset4">
				<h1 class="text-center text-info"> LiveChat </h1>
				<p class="text-info text-center">Selamat Datang di LiveChat </br> Web Chatting ! </p>
			</div>
		</div>
		<div class="row">
			<div class="span4 offset4">
		...
		<div class="row">
			<div class="span4 offset4">
				...
				<p class="text-center text-danger"> Copyright 2017 LiveChat&Team </p>
			</div>
		</div>
		<!-- MODAL -->
		<div id="modalmasuk" class="modal hide fade">
			<div class="modal-header">
				<h3> Masuk LiveChat</h3>
			</div>
			...
			<div class="modal-body">
				<form class="form-horizontal" id="formdaftar">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="password" id="dpass" placeholder="Password" required required x-moz-errormessage='Form harus diisi 5-10 Karakter !'
							    pattern=".{5,10}">
						</div>
					</div>
					<div class="control-group">
...
<head>
	<title> LiveChat, Ruang Percapakan </title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link href="bootstrap/css/bootstrap.css" rel="stylesheet">
	<link href="bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
	...
	<div class="container">
		<div class="row">
			<div class="span6 offset2">
				<h1 class="text-info pull-left"> LiveChat room </h1>
			</div>
			<div class="span2">
		...
		<div class="row">
			<div class="span6 offset2">
				...
				<audio controls id="suara">
					<source src="../livechat/chat.mp3" type="audio/mpeg"> Your browser does not support the audio element.
				</audio>
			</div>
			<div class="span2">
				<a href="#" class="btn btn-info" data-toggle="popover" id="emot" type="button" data-placement="top" title="Emoticons (klik)"><i class="icon-eye-open icon-white"></i> Emoticons </a>
			</div>
		</div>
	</div>
</body>
